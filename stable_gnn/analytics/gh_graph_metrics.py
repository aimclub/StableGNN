...
class GHGraphMetrics:
    """
    A utility class for computing various metrics for GH-graphs, including
    centrality, radius, and sparsity-aware loss.
    """
...
class GHLossFunctions:
    """
    A collection of loss functions tailored for GH-graphs, including sparsity-aware
    and centrality-weighted losses.
    """
