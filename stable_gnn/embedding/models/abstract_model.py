...
class BaseNet(torch.nn.Module, ABC):
    """The model for learning latent embeddings in an unsupervised manner for the Geom-GCN layer.

    :param device: (device): Either 'cuda' or 'cpu'.
    :param hidden_layer: (int): The size of the hidden layer (default: 64).
    :param out_layer: (int): The size of the output layer (default: 128).
    ...
    def __init__(
        ...
        """Initialize a BaseNet instance.

        :param device: (device): Either 'cuda' or 'cpu'.
        :param num_featurs: (int): Number of input features.
        :param hidden_layer: (int): Size of the hidden layer (default: 64).
        :param out_layer: (int): Size of the output layer (default: 128).
        :param num_layers: (int): Number of layers in the model (default: 2).
        :param heads: (int): Number of heads in GAT conv (default: 1).
        :param dropout: (float): Dropout (default: 0.0).
        """
    ...
    def reset_parameters(self) -> None:
        """Reset parameters for all convolution layers."""
    ...
    def loss(self, out: Tensor, pos_neg_samples: Tensor) -> Tensor:
        ...
        :param out: (Tensor): Model output.
        :param pos_neg_samples: (Tensor): Positive and negative samples.
        :return: (Tensor): Computed loss.
        """
