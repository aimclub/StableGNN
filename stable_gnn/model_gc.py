...
class ModelName(torch.nn.Module):
    ...
    def convert_dataset(self, data: List[Graph], train_indices: List[int], val_indices: List[int]) -> (List[Graph], List[Graph], List[Graph], int):  # data - правильно ли так тип указывать??
        """
