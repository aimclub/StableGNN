...
generator = HypergraphGenerator(vertex_num=10,
                                edge_num=3,
...
generator = HypergraphGenerator(vertex_num=5,
                                edge_num=4,
                                generation_method=GeneratorMethods.low_order_first)
data = generator()
print(data)
...
generator = HypergraphGenerator(vertex_num=5,
                                edge_num=4,
                                generation_method=GeneratorMethods.high_order_first)
data = generator()
print(data)
...
generator = HypergraphGenerator(vertex_num=5,
                                edge_num=4,
                                generation_method=GeneratorMethods.custom,
                                probability_k_list=prob_k_list)
data = generator()
print(data)
