...
class HypergraphBuilder:
    ...
    def visualize_hypergraph(self, hypergraph: nx.Graph, node_color='lightblue', edge_color='gray', node_size=500, font_size=12):
        """
        ...
        nx.draw(hypergraph, with_labels=True, node_color=node_color, edge_color=edge_color, 
